    ...
    <div className="contenedor-titulo">
        ...
        <div className="contenido margintop">
            <div className="info">
                ...
                <div className="descripcion">
                    <p className='des-proyect'>Este es un proyecto que utiliza la API RandomFox para mostrar imágenes aleatorias de zorros en una página web. Las cuáles se muestran y se borran de pantalla por medio de unos botones.
