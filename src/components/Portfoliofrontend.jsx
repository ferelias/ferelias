    ...
    <div className="contenedor-titulo">
        ...
        <div className="contenido margintop">
            <div className="info">
                ...
                <div className="ver-mas">
                    <NavLink to="https://ferelias.github.io/Cafe-Toulouse/" className="enlace-workpage">Abrir</NavLink>
                </div>
            </div>
        ...
        <div className="contenido margintop">
            <div className="info">
                ...
                <div className="ver-mas">
                    <NavLink to="https://ferelias.github.io/clima-ferel/build/" className="enlace-workpage">Abrir</NavLink>
                </div>
            </div>
...
Para mejorar la velocidad de carga de la página, se ha implementado la técnica de lazy loading en las imágenes. De esta manera, se retrasa la carga de las imágenes hasta que el usuario las necesita o las solicita explícitamente, lo que mejora significativamente el tiempo de carga de la página..</p>
                ...
                <div className="ver-mas">
                    <NavLink to="https://ferelias.github.io/lazy-loanding/" className="enlace-workpage">Abrir</NavLink>
                </div>
            </div>
        ...
        <div className="contenido margintop">
            <div className="info">
                ...
                <div className="ver-mas">
                    <NavLink to="https://ferelias.github.io/Galeria-de-divs/" className="enlace-workpage">Abrir</NavLink>
                </div>
            </div>
